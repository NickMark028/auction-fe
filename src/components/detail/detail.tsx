              ...
              <div className="product__details__pic">
                <div className="product__details__pic__item">
                  <img
                    ...
                    src="asset/img/product/details/product-details-1.jpg"
                    alt=""
                  />
                </div>
                <div className="product__details__pic__slider owl-carousel">
                  <img
                    data-imgbigurl="asset/img/product/details/product-details-2.jpg"
                    src="asset/img/product/details/thumb-1.jpg"
                    alt=""
                  />
                  <img
                    data-imgbigurl="asset/img/product/details/product-details-3.jpg"
                    src="asset/img/product/details/thumb-2.jpg"
                    alt=""
                  />
                  <img
                    data-imgbigurl="asset/img/product/details/product-details-5.jpg"
                    src="asset/img/product/details/thumb-3.jpg"
                    alt=""
                  />
                  <img
                    data-imgbigurl="asset/img/product/details/product-details-4.jpg"
                    src="asset/img/product/details/thumb-4.jpg"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              <div className="product__item">
                <div
                  ...
                  style={{
                    backgroundImage: "url('asset/img/product/product-1.jpg')",
                  }}
                >
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              <div className="product__item">
                <div
                  className="product__item__pic set-bg"
                  style={{
                    backgroundImage: "url('asset/img/product/product-2.jpg')",
                  }}
                >
                  <ul className="product__item__pic__hover">
                    <li>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              <div className="product__item">
                <div
                  className="product__item__pic set-bg"
                  style={{
                    backgroundImage: "url('asset/img/product/product-3.jpg')",
                  }}
                >
                  <ul className="product__item__pic__hover">
                    <li>
            ...
            <div className="col-lg-3 col-md-4 col-sm-6">
              <div className="product__item">
                <div
                  className="product__item__pic set-bg"
                  style={{
                    backgroundImage: "url('asset/img/product/product-7.jpg')",
                  }}
                >
                  <ul className="product__item__pic__hover">
                    <li>
